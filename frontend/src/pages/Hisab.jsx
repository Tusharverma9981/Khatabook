    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="px-6 py-12 max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="text-zinc-400 hover:text-indigo-400 transition duration-200"
                >
                ...
                >
                  <i className="fas fa-trash text-xl">Delete</i>
                </button>
              </div>
            </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={() => navigate("/")}
            className="inline-flex items-center justify-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-white px-6 py-3 rounded-lg font-semibold transition"
          >
